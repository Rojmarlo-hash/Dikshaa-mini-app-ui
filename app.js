...
const commandGuides = {
  "/weeklyawards": "Shows the weekly group award preview first. Nothing is posted until admin approval.",
...
function openCommandDetail(command) {
  ...
  const guide = commandGuides[command.cmd] || "This card opens Dikshaa's existing private admin flow. If you are not a verified admin, admin actions stay locked.";
...
function initTelegram() {
  ...
  htmlRoot.classList.add("telegram-webview");
